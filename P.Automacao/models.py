...
class Organizador(Config_loader):
    ...
    def Organizar(self):
        try:
            ...
            return ("Organização Feita com Sucesso...")
        ...
        if os.path.exists(self.caminho):
            ...
            for ficheiro in os.listdir(self.caminho):
                ...
                try:
                    ...
                    return (f"ERRO em {ficheiro}:{e}")
                    self.relatorio.append([ficheiro,"Erro: "+str(e),origem])
            return ("BackUp Feito....")
        return "Caminho Inválido: Tente novamente"
        ...
        try:
            if self.relatorio !=[]:
                ...
                with open(caminho_csv,"a",newline="",encoding="utf-8") as arquivo:
                    ...
                    return("Relatório Completo Feito...")
            else:
                return ("Precisas fazer outras operações para gerar um relatório!")
        except Exception as e:
    ...
    def Renomear(self):
        try: 
            if os.path.exists(self.caminho):
                ...
                self.relatorio.append(f"Foram renomedos: {self.renomeados} ficheiros")
                return f"{self.renomeados} foram renomeados"
            else:
                return "Caminho Inválido: Tente Novamente"
        except Exception as e:
            self.relatorio.append([ficheiro,"Erro: "+str(e),origem])
